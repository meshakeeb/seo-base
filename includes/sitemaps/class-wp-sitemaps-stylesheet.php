...
class WP_Sitemaps_Stylesheet {
	...
	public function get_sitemap_stylesheet() {
		...
		$title       = esc_xml( __( 'XML Sitemap', 'nhg-seo' ) );
		$description = esc_xml( __( 'This XML Sitemap is generated by WordPress to make your content more visible for search engines.', 'nhg-seo' ) );
		$learn_more  = sprintf(
			'<a href="%s">%s</a>',
			esc_url( 'https://www.sitemaps.org/' ),
			esc_xml( __( 'Learn more about XML sitemaps.', 'nhg-seo' ) )
		);

		$text = sprintf(
			/* translators: %s: Number of URLs. */
			esc_xml( __( 'Number of URLs in this XML Sitemap: %s.', 'nhg-seo' ) ),
			'<xsl:value-of select="count( sitemap:urlset/sitemap:url )" />'
		);

		$lang       = get_language_attributes( 'html' );
		$url        = esc_xml( __( 'URL', 'nhg-seo' ) );
		$images     = esc_xml( __( 'Images', 'nhg-seo' ) );
		$lastmod    = esc_xml( __( 'Last Modified', 'nhg-seo' ) );
		$changefreq = esc_xml( __( 'Change Frequency', 'nhg-seo' ) );
		$priority   = esc_xml( __( 'Priority', 'nhg-seo' ) );
